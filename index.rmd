...
ui.training <-
  fluidPage(
    fluidRow(
      column(4, align="center",
        sliderInput("epoch.increment", label="Numer of Epochs to Train", value=16, min=1, max=128, step=1),
...
server.training <- function(input, output){
  ...
  initialize_model <- function() {
    ...
    model <- keras_model_sequential(name="MNIST Classifier") %>%
              layer_dense(units=3, activation='relu', input_shape=c(784), name="Hidden-Layer") %>%
